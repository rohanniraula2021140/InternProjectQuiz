			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item" href="<?= base_url('/Patient/edit') ?>">Add Patient</a></li>
						<li><a class="dropdown-item" href="<?= base_url('/Patient/listPatient') ?>">View Patient</a>
						</li>
					</ul>
				</li>
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<li><a class="dropdown-item" href="<?= base_url('/billing/listBills') ?>">View tests</a></li>
					</ul>
				</li>
			</ul>
			<div class="d-flex">
